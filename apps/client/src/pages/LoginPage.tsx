      ...
      <div className="flex h-full w-full">
        ...
        <div className="hidden lg:flex flex-col justify-center items-center w-1/2 bg-primary-container text-on-primary p-gutter relative overflow-hidden">
          ...
          >
            ...
            <h1 className="font-display-lg text-display-lg text-on-primary font-bold">Welcome to ProHub</h1>
            <p className="font-body-lg text-body-lg text-on-primary opacity-80 leading-relaxed">
              Log in to access your professional dashboard, connect with experts, and showcase your growth.
            </p>
          </motion.div>
        ...
        <div className="flex w-full lg:w-1/2 justify-center items-center bg-surface p-margin-desktop md:p-12 overflow-y-auto">
          ...
          >
            ...
            <div className="space-y-unit text-center lg:text-left">
              <h2 className="font-headline-lg text-headline-lg font-bold text-on-surface">Sign In</h2>
              <p className="font-body-lg text-body-lg text-on-surface-variant">Enter your credentials to continue your journey.</p>
            </div>
            ...
            <form className="space-y-6 mt-8" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="flex justify-end">
                <a className="font-label-lg text-label-lg text-primary hover:underline transition-colors" href="#">
                  Forgot password?
                </a>
              </div>
            ...
            <p className="text-center font-body-lg text-body-lg text-on-surface-variant mt-8">
              New to ProHub? <Link className="text-primary hover:underline font-bold" to="/register">Create an account</Link>
            </p>
          </motion.div>
        </div>
      </div>
